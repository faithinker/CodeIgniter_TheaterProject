...
<!--
        ...
        <section class="container">
            <div class="col-sm-12">
                <h2 class="page-heading">Event 시사회/무대인사</h2>
                ...
                <div class="gallery-wrapper">
                    ...
                    <div class="col-sm-4">
                        <div class="gallery-item">
                            <a href='/~team2/event/view_p/no/<?=$row->no?>' class="gallery-item__image gallery-item">
                                <img width="524" height="524" alt='' src="/~team2/movie_img/<?=$row->pic1; ?>">
                            </a>
                            <a href='/~team2/event/view_p/no/<?=$row->no?>'  class="gallery-item__descript ">
