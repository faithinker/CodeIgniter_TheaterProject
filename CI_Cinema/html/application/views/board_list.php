...
<body>
    <div class="wrapper">
        ...
        <!-- Main content -->
            ...
            <div class="col-sm-8">
			                <h2 class="page-heading">우리 동네 영화관 </h2>
			</div>
			 <div class="col-sm-4" align="right">
			                <h2><a href="/~team2/board/add" class="btn btn-md btn--shine">글쓰기</a></h2>
			</div>
			<div class="col-sm-12">
					<table class="tbl_event" id="eventList">
                   
                    
					<div class="panel-group accordion-light in" id="accordion" style="height: auto;">
<? 
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?=$row->no?>" class="collapsed">
                                  <span class="marker">
                                    <span class="custom1">+</span>
                                    <span class="custom2">-</span>
                                  </span>
                                  <p style="font-weight:bold"><?=$row->jijum_name?> 지점</p> <?=$row->title?>
                                </a>
                              </h4>
                            </div>
                            <div id="collapse<?=$row->no?>" class="panel-collapse collapse" style="height: 0px;">
                              <div class="panel-body">
							   기간 : <?=$row->term?> <br><br>
                                <p style="font-style:15px"><?=$row->contents?></p>
                              </div>
                            </div>
                          </div>
                          <!-- end accordion item -->
