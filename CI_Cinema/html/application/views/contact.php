...
<!--
        ...
        <section class="container">
            ...
            <div class="contact">
                <p class="contact__title">문제된 상황이 있으신가요?<br><span class="contact__describe">언제든지 문의를 남겨주세요.</span></p>
                <span class="contact__mail">engeliss72@naver.com</span>
                <span class="contact__tel">010-0000-0000</span>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                    <form class="form row" method='post' novalidate="" >
                        ...
                        <button type="button" class='btn btn-md btn--danger'><a href="/~team2/contact/send">Send</button>
                    </form>
                </div>
            </div>
        </div>
