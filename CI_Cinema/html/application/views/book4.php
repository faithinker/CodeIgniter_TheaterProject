                    ...
                    <div class="ticket-position">
                        ...
                        <div class="ticket__inner">
							...
							?>
                                ...
                                <span class="ticket__item ticket__date"><?=$row->date_no?></span>
                                <span class="ticket__item ticket__time"><?=$row->time_no?></span>
                                <span class="ticket__item">City : <span class="ticket__cinema"><?=$row->city_name?></span></span>
                                <span class="ticket__item">Jijum : <span class="ticket__hall"><?=$row->jijum_name?> 점</span></span>
                                <span class="ticket__item ticket__price">price: <strong class="ticket__cost">$ <?=$row->price?></strong></span>
                            </div>

                            <div class="ticket-primery">
                                <span class="ticket__item ticket__item--primery ticket__film">Film<br><strong class="ticket__movie"><?=$row->movie_name?></strong></span>

								<?
								$test = explode(',', $row->seat_no);
								$count=count($test);
								?>
