         ...
         <script>
            ...
            <div class="main-content">
					...
					<td width="80%" align="left">
						<div class="form-inline" style="display:block">
							...
							<? if($row->kind ==0){?>
							  ...
							  <option value=0 selected>영화</option>
							  <option value=1 >시사회/무대인사</option>	 
							<? }
							else {?>
								<option value="">선택하세요.</option>
							  <option value=0 >영화</option>
							  <option value=1 selected>시사회/무대인사</option>	 
							<? } ?>
				...
				<tr>
						...
						현재 메인사진 : <img src="/~team2/movie_img/<?=$row->pic1?>" style="width:500px;height:500px">
					<td width="80%" align="left">
						<div class="form-inline" style="display:block">
				...
				<tr>
						...
						현재 메인사진 : <img src="/~team2/movie_img/<?=$row->pic2?>" style="width:500px;height:500px">
					<td width="80%" align="left">
						<div class="form-inline" style="display:block">
