                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>genre data</h3>
                                    <div class="filters m-b-45">
										<div class="input-group-append">
											...
											<button type="button" class="btn btn-info"><a href="/~team2/admingenre/add">추가</a></button>
										</div>		
										<br>
                                    ...
                                    <div class="table-responsive table-data" style="background:#EAEAEA; height:672px;">
										...
										<td style="background-color:lightgray;"><a href="/~team2/admingenre/edit/no/<?=$row->no;?>" role="button">수정</a> /
												
													<a href="/~team2/admingenre/del/no/<?=$row->no;?>" onClick="return confirm('정말 지우시겠습니까?');" role="button">삭제</a></td>
                                                </tr>
