                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>jijum data</h3>
                                    <div class="filters m-b-45">
										...
										<button type="button" class="btn btn-info"><a href="/~team2/adminjijum/add">추가</a></button>
                                    </div>
                                </form>
                                    ...
                                    <div class="table-responsive" style="background:#EAEAEA; ;">
                                        <table class="table" style="padding-bottom:0px;">
                                            ...
                                            <thead>
                                                <tr style="text-align:center">
													<td width="20%">no</td>
													<td width="30%">도시 이름</td>
													<td width="30%">지점 이름</td>
										...
										<td style="background-color:lightgray;"><a href="/~team2/adminjijum/edit/no/<?=$row->no;?>" role="button">수정 </a>
												/
													<a href="/~team2/adminjijum/del/no/<?=$row->no;?>" onClick="return confirm('정말 지우시겠습니까?');" role="button">삭제</a></td>
                                                </tr>
