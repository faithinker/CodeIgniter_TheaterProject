                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>영화 추가</h3>
...
<form name="form1" method="post" enctype="multipart/form-data">
				...
				<tr>
					...
					<td width="80%" align="left">
						<div class="form-inline" style="display:block">
						<textarea name="synopsis" style="width:40%;height:200px; opacity:.8" class="form-control form-control-sm"></textarea>
				...
				<tr>
					...
					<td width="80%" align="left">
						<div class="form-inline" style="display:block">
							<input  type="text" name="director" size="20" maxlength="20" value=""
										 class="form-control form-control-sm">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td width="80%" align="left">
						<div class="form-inline" style="display:block">
							<input  type="text" name="actor" size="20" maxlength="20" value=""
										 class="form-control form-control-sm">
						</div>
					</td>
				</tr>
				<tr>
					<td width="20%" class="mycolor2" style="vertical-align:middle">
						...
						<div class="form-inline">
								<input type="text" name="openday1" size = "4" maxlength = "4" value = "" class="form-control form-control-sm"> <font color="898989">년</font>&nbsp
								<input type="text" name="openday2" size = "2" maxlength = "2" value = "" class="form-control form-control-sm"> <font color="898989">월</font> &nbsp
								<input type="text" name="openday3" size = "2" maxlength = "2" value = "" class="form-control form-control-sm"> <font color="898989">일</font>							
							&nbsp&nbsp&nbsp
							</div>
						</td>
				</tr>
						...
						<div class="form-inline" style="display:block">
							<select id="select-box" name="genre_no" class="form-control form-control-sm" >
							  ...
							  <?
									...
									foreach($list as $row){ //여기에는 genredb가 들어있음
								  if($row->no==$genreno)
				...
				<tr>
					...
					<td width="80%" align="left">
						<div class="form-inline" style="display:block">
							<input  type="text" name="running_time" size="5" maxlength="5" value=""
