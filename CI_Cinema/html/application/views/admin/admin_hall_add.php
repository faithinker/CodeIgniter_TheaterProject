            ...
            <div class="main-content">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>관 추가</h3>
				...
				<tr>
					<td width="20%" class="mycolor2" style="vertical-align:middle">
						<font color="red">*</font> 지점 이름
					</td>
					<td width="80%" align="left">
						<div class="form-inline" style="display:block">
							<select id="select-box" name="jijum_no" class="form-control form-control-sm" id="name">
							  <option value="">선택하세요.</option>
							  <?
							  $jijumno=set_value("jijumno");

									foreach($list as $row){ //여기에는 citydb가 들어있음
								  if($row->no==$jijumno)
