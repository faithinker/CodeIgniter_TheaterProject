...
<head>
    ...
    <!-- Vendor CSS-->
    <link href="/~team2/vendor/animsition/animsition.min.css" rel="stylesheet" media="all">
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="/~team2/images/icon/logo.png" alt="CoolAdmin">
                            </a>
                        </div>
                        <div class="login-form">
                            <form action="http://gamejigix.induk.ac.kr/~team2/adminlogin/check" method="post">
                                <div class="form-group">
                                    <label>아이디</label>
                                    <input class="au-input au-input--full" type="text" name="id" placeholder="아이디">
                                </div>
                                <div class="form-group">
                                    <label>비밀번호</label>
                                    <input class="au-input au-input--full" type="password" name="pwd" placeholder="비밀번호">
                                </div>
                                
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit">로그인하기</button>
                            </form>
