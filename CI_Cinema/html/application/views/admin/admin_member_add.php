         ...
         <script>
            ...
            <div class="main-content">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>멤버 추가</h3>
				...
				<tr>
					...
					<td width="80%" align="left">
						<div class="form-inline" style="display:block">
							<input  type="text" name="uid" size="20" maxlength="20" value="<?=set_value("uid"); ?>"
										 class="form-control form-control-sm">
				...
				<tr>
					...
					<td width="80%" align="left">
						<div class="form-inline" style="display:block">
							<input  type="text" name="pwd" size="20" maxlength="20" value="<?=set_value("pwd"); ?>"
										 class="form-control form-control-sm">
				...
				<tr>
					...
					<td>
					<div class="form-inline">
							<input type="text" name="birthday1" size = "4" maxlength = "4" value = "" class="form-control form-control-sm"> <font color="898989">년</font>&nbsp
							<input type="text" name='birthday2' size = "2" maxlength = "2" value = "" class="form-control form-control-sm"> <font color="898989">월</font> &nbsp
							<input type="text" name='birthday3' size = "2" maxlength = "2" value = "" class="form-control form-control-sm"> <font color="898989">일</font>							
						&nbsp&nbsp&nbsp
