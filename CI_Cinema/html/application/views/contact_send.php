...
<!--
		...
		<img src="/~team2/images/icons/send.JPG">
		</div>
            <div class="contact" style=" text-align: center;">
				<p></p>
				<p>성공적으로 접수되었습니다. </p>
				<p>빠른 시간 내에 답변 드리겠습니다</p>
                <p>항상 노력하는 TOCINEBA가 되겠습니다.</p>
            </div>
			<div class="col-sm-6">
				<div class="btn-demo" align="right" >
				<a href="/~team2/contact" class="btn btn-md btn--slow">문의로 돌아가기</a>
			</div>
				</div>
			<div class="col-sm-6">
				<div class="btn-demo" align="left" >
					<a href="/~team2" class="btn btn-md btn--slow">메인 돌아가기</a>
            </div>
				</div>
        </section>
