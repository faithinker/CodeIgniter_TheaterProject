...
<div class="clearfix"></div>
        ...
        <section class="cinema-container mymarginright20">
            <div class="cinema cinema--full">
                <div class="cinema__rating" style="width:100%">Super 4D</div>
                <div id="content">
                    <div class="spec_shwrap">
                        <img src="/~team2/images/cinema_img/super_4d_1.jpg">
                    </div>
                    <div class="spec_shwrap">
                        <img src="/~team2/images/cinema_img/super_4d_2.jpg">
                    </div>
                    <div class="spec_shwrap">
                        <img src="/~team2/images/cinema_img/super_4d_3.jpg">
                    </div>
                    <div class="spec_shwrap">
                        <img src="/~team2/images/cinema_img/super_4d_4.jpg">
                    </div>
                    <div class="spec_shwrap">
                        <img src="/~team2/images/cinema_img/super_4d_5.jpg">
                    </div>
                </div>
                <div class="cinema__info" style="width:100%">
                    <p class="cinema__info-item"><strong>주소:</strong> 서울 중구 명동 </p>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 col-md-5">
                                                        <div class="movie__images">
                                                            ...
                                                            <img alt='' src="/~team2/images/movie/movie-time1.jpg">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 col-md-5">
                                                        <div class="movie__images">
                                                            ...
                                                            <img alt='' src="/~team2/images/movie/movie-time2.jpg">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 col-md-5">
                                                        <div class="movie__images">
                                                            ...
                                                            <img alt='' src="/~team2/images/movie/movie-time3.jpg">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="movie movie--time">
                                                <div class="row">
                                                    <div class="col-sm-6 col-md-5">
                                                        <div class="movie__images">
                                                            <span class="movie__rating">4.9</span>
                                                            <img alt='' src="/~team2/images/movie/movie-time4.jpg">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="comment-sets comment--light">
                                              <div class="comment">
                                                  <div class="comment__images">
                                                      <img alt='' src="/~team2/images/comment/avatar-olia.jpg">
                                                  </div>
                                              ...
                                              <div class="comment comment--answer">
                                                  <div class="comment__images">
                                                      <img alt='' src="/~team2/images/comment/avatar-dmitriy.jpg">
                                                  </div>
                                              ...
                                              <div class="comment comment--last">
                                                  <div class="comment__images">
                                                      <img alt='' src="/~team2/images/comment/avatar-sia.jpg">
                                                  </div>
...
var map = new naver.maps.Map('cinema-map', {
    center: new naver.maps.LatLng(37.564240, 126.981757),
    zoom: 12 
});
...
var defaultMarker = new naver.maps.Marker({
    position: new naver.maps.LatLng(37.564340, 126.981657),
    map: map,
    icon: {
