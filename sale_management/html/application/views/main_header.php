...
<div class="container-fluid"><!-- container:고정된 가로 폭 / container-fluid:화면 전체 가로 폭 -->
  ...
  <a class="navbar-brand" href="/~sale8">판매관리</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav mr-auto"> <!-- mr-auto: 양쪽 정렬 -->
      <li class="nav-item">
      <a class="nav-link" href="/~sale8/jangbui">매입</a>
      </li>
      <li class="nav-item">
      <a class="nav-link" href="/~sale8/jangbuo">매출</a>
      </li>
      <li class="nav-item">
      <a class="nav-link" href="/~sale8/gigan">기간조회</a>
      </li>
      ...
      <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
        <a class="dropdown-item" href="/~sale8/best">Best제품</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item" href="/~sale8/crosstab">월별제품별현황</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item" href="/~sale8/graph">종류별분포도</a>
      </div>
      </li>
      <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
        <a class="dropdown-item" href="/~sale8/gubun">구분</a>
        <a class="dropdown-item" href="/~sale8/product">제품</a>
      <?
        if($this->session->userdata('rank')==1)
        echo("
          <div class='dropdown-divider'></div>
            <a class='dropdown-item' href='/~sale8/member'>사용자</a>
          </div>"
        );
      ?> 
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/~sale8/picture">사진</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/~sale8/ajax">ajax</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/~sale8/test">Test</a>
      </li>
      <li class="nav-item">
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="4000">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active carousel-item-left">
      <img src="/~sale8/my/img/main1.jpg" class="d-block w-100" alt="1.jpg" height="180">
    </div>
    <div class="carousel-item carousel-item-next carousel-item-left">
      <img src="/~sale8/my/img/main2.jpg" class="d-block w-100" alt="2.jpg" height="180">
    </div>
    <div class="carousel-item">
      <img src="/~sale8/my/img/main3.jpg" class="d-block w-100" alt="3.jpg" height="180">
    </div>
  </div>
...
<script src="my/js/slick.js" type="text/javascript" charset="utf-8"></script>
