...
<div align="center" style="margin: 10px;">
   ...
   <a href="/~sale8/jangbuo/edit<?=$tmp; ?>" class="btn btn-primary">수정</a>
   <a href="/~sale8/jangbuo/del<?=$tmp; ?>" onClick="return confirm('삭제할까요?');" class="btn btn-primary">삭제</a>
   <a href="/~sale8/jangbuo/lists/" onClick="javascript:history.back();" class="btn btn-primary">이전화면</a>
